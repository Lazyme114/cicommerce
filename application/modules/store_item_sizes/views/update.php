...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<?php
			$url = base_url()."store_item_sizes/update/".$item_id;
			?>
			<form class="form-horizontal" action="<?php echo $url; ?>" method="post">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span5" name="size" id="size" value="">
						</div>
					</div>
...
<?php if ($sizes->num_rows() > 0 ): ?>
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon white user"></i><span class="break"></span>Item Sizes</h2>
				<div class="box-icon">
					<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
					<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
				</div>
			...
			<div class="box-content">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<?php $i = 1; foreach($sizes->result() as $row) { 
							$delete_item_url = base_url()."store_item_sizes/delete/".$row->id."/".$row->item_id;
							?>
							<tr>
								<td><?php echo $i++; ?></td>
								<td class="center">
