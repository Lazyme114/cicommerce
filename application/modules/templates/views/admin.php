	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>CIShop</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a href="<?php echo base_url(); ?>store_items/manage">
								<i class="icon-shopping-cart"></i>
								<span class="hidden-tablet">Manage Items</span>
							</a>
						</li>

						<li>
							<a href="<?php echo base_url(); ?>store_categories/manage">
								<i class="icon-list-alt"></i>
								<span class="hidden-tablet">Manage Categories</span>
							</a>
						</li>
